...
public class CheckingAddBalence {
    ...
    public void addBalenceNoOverdraft() {
        ...
        his.add("09-19-2019");
        Checking c1 = new Checking("123","000000000",10,"10-10-2010",0,"321","555",his, null,null,null,"",null);
    ...
    public void addBalenceOverdraft() {
        ...
        ArrayList<String> his = new ArrayList<>();
        his.add("09-19-2019");
        Checking c1 = new Checking("123","000000000",0,"10-10-2010",0,"321","555",his, null,null,null,"",null);
